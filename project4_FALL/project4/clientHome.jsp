...
<head>
    <meta charset="utf-8" />
    <title>CNT 4714 Project 4 Client-level Home Page</title> 
    <style type="text/css">
       body {
...
<body>
    ...
    <p>You are connected to the project 4 Enterprise System database as a <span style="color: red;">client-level</span> user. </p>
    <p>Please enter any SQL query or update command in the box below.</p><br>
    <form action="/project4/clientuser" method="post">
